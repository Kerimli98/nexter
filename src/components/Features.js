  ...
  return (
    ...
    <div className="feature">
        <svg className="feature__icon">
            <use xlinkHref="assets/img/sprite.svg#icon-global"></use>
        </svg>
    ...
    <div className="feature">
        <svg className="feature__icon">
            <use xlinkHref="assets/img/sprite.svg#icon-trophy"></use>
        </svg>
    ...
    <div className="feature">
        <svg className="feature__icon">
            <use xlinkHref="assets/img/sprite.svg#icon-presentation"></use>
        </svg>
    ...
    <div className="feature">
        <svg className="feature__icon">
            <use xlinkHref="assets/img/sprite.svg#icon-lock"></use>
        </svg>
